...
const BasicTable = ({ serial, setSerial }) => {
    ...
    const [run, setRun] = useState("not running");
    const handleRun = async () => {
        const test = await running(serial); // Pass the serial to the running function
        setRun(test);
    };
